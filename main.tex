...
%%%%%%%%%%%%%%%%%%%%% Sætnings design
% https://fred.stlouisfed.org/series/LRHUADTTEZM156N
% https://fred.stlouisfed.org/series/LFHUADTTDKM647N
...
\titel{Pricing Strategies CGMAI3027 E+T}
\undertitel{Exam company: BYD}
\opgave{Final Exam}
\forfatter{MSc in Business Administration and Mathematical Business Economics}
\vejleder{Professors: xxx}
\normalsider{Number of pages: 10}
\anslag{\hspace{0.12cm}July 13 2026}
\date{Studentnumber: S160645}
...
\fancyhead[L]{KAN-CDSCO1005U} % Venstre sidehoved
...
\setlength{\headsep}{5mm}  %Afstand mellem sidehoved og overskrift
...
\DeclareFieldFormat{textcite}{%
  \DeclareFieldAlias{bibhyperref}{noformat}%h
  \bibhyperref{#1}}
...
\input{Afsnit/01_introduction}

\newpage

\input{Afsnit/02_literature_review}

\input{Afsnit/03_data}

\input{Afsnit/04_methodology}

\input{Afsnit/05_results}

\input{Afsnit/06_discussion}

\input{Afsnit/07_conclusion}
